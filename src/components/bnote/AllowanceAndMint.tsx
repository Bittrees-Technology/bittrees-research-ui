...
import { useManageAllowanceTransaction } from "@/hooks/erc20/useManageAllowanceTransaction.tsx";
import { useMint } from "@/hooks/bnote/useMint.tsx";
import { useMintingInfo } from "@/hooks/bnote/useMintingInfo.tsx";
...
export function AllowanceAndMint({
  ...
  }, [isSuccessfulMint, mintComplete, txData]);
